...
<table id="info">
  <tr><td class="label" valign='bottom' width="129">Server Name:</td><td><a href="channelid://0" class="TextMessage_ServerLink">%%SERVER_NAME%%</a></td></tr>
  <tr><td class="label"><a title="Locate GEO location. This will open an external link and forward you to tsindex.com!" class="silent-link" href="https://ts3index.com/geo/#%%SERVER_ADDRESS%%">Server Address</a>:</td><td>%%SERVER_ADDRESS%%
    :%%?SERVER_PORT%%</td></tr>
  <tr><td class="Label">Server Nickname(s):</td><td>%%?SERVER_NICKNAMES%%</td></tr>
  <tr><td class="label"><a title="Lookup server in server list. This will open an external link and forward you to tsindex.com!" class="silent-link" href="https://ts3index.com/?page=serverlist&uid=%%SERVER_UNIQUE_ID%%">Unique ID</a>:</td><td>%%SERVER_UNIQUE_ID%%</td></tr>
