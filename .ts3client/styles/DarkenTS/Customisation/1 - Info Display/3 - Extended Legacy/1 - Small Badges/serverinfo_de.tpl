...
<table id="info" border="0">
  ...
  <tr><td class="label">Serveraddresse: <a title="Lokalisiere Serverstandort. Dies wird einen externen Link öffnen und zu ts3index.com weiterleiten!" class="silent-link" href="https://ts3index.com/geo/#%%SERVER_ADDRESS%%"><img class="vert-mid" src="iconpath:MESSAGE_INFO?size=10x10" /></a></td><td>%%SERVER_ADDRESS%%
    :%%?SERVER_PORT%%</td></tr>
  <tr><td class="Label">Serverspitzname(n):</td><td>%%?SERVER_NICKNAMES%%</td></tr>
  <tr><td class="label">Eindeutige Server ID: <a title="Schlage Server in Serverliste nach. Dies wird einen externen Link öffnen und zu ts3index.com weiterleiten!" class="silent-link" href="https://ts3index.com/?page=serverlist&uid=%%SERVER_UNIQUE_ID%%"><img class="vert-mid" src="iconpath:MESSAGE_INFO?size=10x10" /></a></td><td>%%SERVER_UNIQUE_ID%%</td></tr>
