...
%%??CHANNEL_FLAG_NORMAL%%<table>
%%??CHANNEL_FLAG_NORMAL%%  <tr title="Request Talk Power to be able to talk in this Channel."><br/><td class="label" width="129">Needed Talk Power:</td><td class="redder"><img class="vert-mid" src="iconpath:MODERATED" />%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr></table>
