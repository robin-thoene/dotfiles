...
%%??CHANNEL_FLAG_NORMAL%%	<tr title="%%CHANNEL_NAME_PLAIN%%<br/><br/>Channel Order: %%CHANNEL_ORDER%%"><td class="label" width="152">Kanalname:</td>
...
%%??CHANNEL_VOICE_DATA_ENCRYPTED_FLAG%%<span class="green"><img class="vert-mid" src="iconpath:APPLY" />
%%??CHANNEL_FLAG_NORMAL%%        %%CHANNEL_VOICE_DATA_ENCRYPTED%%</span>
</td></tr>
%%??CHANNEL_FLAG_NORMAL%%</table>

%%??CHANNEL_FLAG_NORMAL%%<table>
%%??CHANNEL_FLAG_NORMAL%%  <tr title="Fordere Rederechte an um in diesem Kanal sprechen zu können."><br/><td class="label" width="152">Ben&ouml;tigtes Rederecht:</td><td class="redder"><img class="vert-mid" src="iconpath:MODERATED" />%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr></table>
