...
%%??CHANNEL_FLAG_NORMAL%%	<tr title="%%CHANNEL_NAME_PLAIN%%<br/><br/>Channel Order: %%CHANNEL_ORDER%%"><td class="label" width="152">Channel Name:</td>
...
%%??CHANNEL_FLAG_NORMAL%%<table>
%%??CHANNEL_FLAG_NORMAL%%  <tr title="Fordere Rederechte an um in diesem Kanal sprechen zu können."><br/><td class="label" width="152">Ben&ouml;tigtes Rederecht:</td><td class="redder"><img class="vert-mid" src="iconpath:MODERATED?size=16x16" />%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr></table>
